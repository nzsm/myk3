...
sed -i "s/OpenWrt /nzsm build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g""cut -c1-2 /sys/class/thermal/thermal_zone0/temp" package/lean/default-settings/files/zzz-default-settings
